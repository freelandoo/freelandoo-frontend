...
import type { UseIntentResult } from "./useIntent"
...
// View pesada (framer-motion + gsap) carregada por next/dynamic a partir do
// gate em IntentModal.tsx — F3.S7 (shell). O estado vem de useIntent via
// props pra o gate decidir montar sem pagar este chunk.

export function IntentModalView({
  shouldShow,
  status,
  working,
  chosen,
