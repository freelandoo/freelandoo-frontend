...
export const TOUR_CONFIGS: TourConfig[] = [
  {
    ...
    steps: [
      ...
      { id: "welcome-dropside-payments", target: "[data-tour='dropside-payments']", title: "Pagamentos & Ativações", content: "Histórico de cobranças, assinaturas dos perfis e reembolsos.", placement: "right" },
  ...
  { tourKey: "account_auth", title: "Conta e Autenticação", description: "Segurança e conta-base", version: 1, pagePath: ["/account", "/login", "/cadastro"], steps: [
    ...
    { id: "account-3", title: "A conta não é vitrine", content: "Para aparecer para clientes, crie um perfil.", placement: "center" },
  ]},
  ...
  { tourKey: "subprofiles", title: "Perfis", description: "Vitrines profissionais", version: 1, pagePath: ["/account"], steps: [{ id: "subprofiles-1", title: "Perfis são suas vitrines", content: "É no perfil que você vende serviços, produtos e cursos.", placement: "center" }] },
  {
    tourKey: "enxames",
  ...
  { tourKey: "subprofile_store", title: "Loja em perfil", description: "Vendas no perfil", version: 1, pagePath: ["/account/profile"], steps: [{ id: "store-1", title: "Sua loja dentro do perfil", content: "Perfis pagos podem vender produtos no próprio perfil.", placement: "center" }] },
  ...
  { tourKey: "uploads_r2", title: "Upload de mídia", description: "Mídia escalável", version: 1, pagePath: ["/account", "/account/courses"], steps: [{ id: "r2-1", title: "Envio de mídia", content: "Arquivos vão para a nuvem da Freelandoo com regras por tipo de upload.", placement: "center" }] },
