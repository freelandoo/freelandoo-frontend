        ...
        >
          ...
          */}
          <div
            ...
            style={{
              background: [
                "linear-gradient(to right, rgb(0 0 0 / 0.94) 0%, rgb(0 0 0 / 0.88) 38%, rgb(0 0 0 / 0.55) 72%, rgb(0 0 0 / 0.70) 100%)",
                "linear-gradient(to bottom, rgb(0 0 0 / 0.72) 0%, rgb(0 0 0 / 0.10) 30%, rgb(0 0 0 / 0.45) 78%, rgb(0 0 0 / 1) 100%)",
              ].join(","),
            }}
          />
        </div>
