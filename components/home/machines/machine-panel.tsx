    ...
    >
      ...
      <div className="container relative z-10 mx-auto grid w-full grid-cols-1 gap-8 px-4 py-16 lg:grid-cols-2 lg:gap-12 lg:py-0">
        ...
        <div className="flex flex-col justify-center">
          ...
          >
            <span
              className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[10px] uppercase tracking-[0.25em] backdrop-blur"
              style={{ color: machine.colors.text }}
            >
              <Zap className="h-3 w-3" style={{ color: machine.colors.accent }} />
          ...
          <motion.h2
            ...
            className="mt-5 text-balance text-3xl font-semibold tracking-tight text-white md:text-4xl lg:text-5xl"
          >
            {machine.headline}
          </motion.h2>
          ...
          <motion.p
            ...
            className="mt-4 max-w-lg text-pretty text-white/60 md:text-lg"
          >
            {machine.subheadline}
          </motion.p>
