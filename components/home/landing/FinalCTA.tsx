...
import { GoldButton, YellowHighlight, PhotoFrame, HiveDoodle, Squiggle, DoodleArrow, HoneycombField } from "./primitives"
    ...
    <section className="relative overflow-hidden px-5 py-20 sm:px-8 md:py-28">
      ...
      <div className="relative mx-auto grid w-full max-w-[1180px] items-center gap-10 md:grid-cols-[0.9fr_1.1fr]">
        <div data-reveal className="relative">
          <PhotoFrame src="/landing/cta-grupo.jpg" alt="Pessoas felizes ganhando com a Freelandoo" className="aspect-[5/4] w-full rounded-3xl" />
        ...
        <div data-reveal className="relative">
          ...
          <h2 className="fl-display text-4xl text-[#F5F1E8] sm:text-5xl md:text-[3.4rem]">
            ...
            <YellowHighlight>Tudo em um só lugar.</YellowHighlight>
          </h2>
