    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4" role="dialog" aria-modal="true">
      <div className="relative w-full max-w-md rounded-2xl bg-card p-6 shadow-xl">
        ...
        <h2 className="inline-flex items-center gap-2 text-lg font-bold">
          <Flag className="h-4 w-4 text-amber-300" aria-hidden /> Denunciar mensagem
        </h2>
        <p className="mt-1 text-xs text-muted-foreground">
          A moderação revisa todas as denúncias. Mensagens com várias denúncias são ocultadas automaticamente.
        </p>
