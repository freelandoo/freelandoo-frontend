...
export function CommunityRankingFull({ communityId }: { communityId: string }) {
  ...
  // ⚠️ O carro NÃO leva a pele para cá desde a 5ª passada: ela ficou CLARA
  // (capa de jogo), e esta tela escreve a tinta em `#F1EDE2`, que as peles
  // claras deixam de fora — mesma razão pela qual o pet também não vem.
