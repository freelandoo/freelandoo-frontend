    ...
    <div className="fl-root flex min-h-[100dvh] items-center justify-center bg-[#141009] px-4 py-16">
      <div className="w-full max-w-md text-center">
        <div className="fl-card fl-hard rounded-[6px] p-8 sm:p-10">
          ...
          <p className="fl-marker text-xl font-bold leading-none text-[#0B0B0D]/55">Agendamento</p>
          <h1 className="fl-display mt-1 text-4xl leading-[0.9] text-[#0B0B0D] sm:text-5xl">CONFIRMADO.</h1>
          <p className="mx-auto mt-5 max-w-sm text-sm font-bold leading-relaxed text-[#5b554b]">
            Seu pagamento foi processado e o profissional foi notificado. Você receberá um email
