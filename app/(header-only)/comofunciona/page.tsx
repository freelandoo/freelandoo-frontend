...
export const metadata: Metadata = {
  ...
  description:
    "Entenda como a Freelandoo conecta quem precisa de serviços com profissionais reais. Enxames, perfis, portfólios, serviços, clans, afiliados e ranking — tudo explicado.",
  openGraph: {
