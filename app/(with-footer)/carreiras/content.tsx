      ...
      <section className="relative overflow-hidden py-24 md:py-36">
        ...
        <div className="container mx-auto px-4 relative max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6" data-reveal>
            Carreiras na Freelandoo
          </h1>
          <p className="text-xl text-muted-foreground mb-4" data-reveal>
            Estamos construindo uma plataforma para conectar profissionais e oportunidades de um jeito mais simples, direto e inteligente.
          </p>
          <p className="text-muted-foreground mb-10 leading-relaxed" data-reveal>
            A Freelandoo está em crescimento. Talvez ainda não tenhamos vagas abertas, mas queremos manter uma porta aberta para pessoas que se identificam com nossa visão.
          </p>
          <div data-reveal>
      ...
      <section className="py-16 md:py-24 bg-card/20">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4" data-reveal>
            Uma plataforma para profissionais, creators e prestadores
          </h2>
          <p className="text-muted-foreground mb-10 leading-relaxed" data-reveal>
            Nosso objetivo é criar uma vitrine inteligente onde quem trabalha possa aparecer melhor e quem procura serviços encontre profissionais com mais clareza.
          </p>
          <div className="mb-4 text-sm font-medium text-foreground" data-reveal>Estamos desenvolvendo recursos como:</div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-12" data-reveal>
            Pessoas que podem construir com a gente
          </h2>
        ...
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="bg-card border border-border rounded-2xl p-8 md:p-12" data-reveal>
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
              No momento, estamos em fase de construção
            </h2>
            <p className="text-muted-foreground mb-4 leading-relaxed">
              Ainda podemos não ter vagas abertas, mas estamos abertos a conhecer pessoas que se conectam com a visão da Freelandoo.
            </p>
            <p className="text-muted-foreground mb-8 text-sm leading-relaxed">
              Se você acredita que pode contribuir com tecnologia, produto, design, marketing, comunidade ou parcerias, acompanhe a evolução da plataforma.
            </p>
            <Link href="/cadastro" className="inline-flex items-center bg-primary text-black font-semibold px-6 py-3 rounded-lg hover:bg-primary/90 hover:shadow-[0_0_20px_rgba(242,196,9,0.35)] transition-all">
              Entrar em contato
            </Link>
