      ...
      <section className="relative overflow-hidden py-24 md:py-32">
        ...
        <div className="container mx-auto px-4 relative max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6" data-reveal>
            Uma comunidade para quem faz acontecer
          </h1>
          <p className="text-xl text-muted-foreground mb-4" data-reveal>
            A Freelandoo aproxima profissionais, criadores, prestadores, empresas e pessoas que procuram soluções reais.
          </p>
          <p className="text-muted-foreground mb-10 leading-relaxed" data-reveal>
            Mais do que uma vitrine, a Freelandoo está construindo uma rede de profissionais conectados por máquinas, interesses, serviços e oportunidades.
          </p>
          <div data-reveal>
      ...
      <section className="py-16 md:py-24 bg-card/20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 max-w-2xl" data-reveal>
            Conexões que vão além do perfil
          </h2>
          <p className="text-muted-foreground mb-12 max-w-2xl leading-relaxed" data-reveal>
            A comunidade Freelandoo nasce para fortalecer quem trabalha por conta própria, quem cria, quem presta serviço e quem quer ser encontrado. A ideia é aproximar pessoas, gerar visibilidade e facilitar novas conexões profissionais.
          </p>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4" data-reveal>
            Para freelancers, prestadores, creators e empresas
          </h2>
          <p className="text-muted-foreground mb-10 max-w-2xl leading-relaxed" data-reveal>
            A comunidade pode reunir quem presta serviços, quem cria conteúdo, quem divulga, quem contrata e quem quer construir presença profissional.
          </p>
        ...
        <div className="container mx-auto px-4 max-w-2xl text-center">
          <div className="bg-card border border-border rounded-2xl p-8 md:p-12" data-reveal>
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
              Estamos construindo essa rede
            </h2>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              A comunidade Freelandoo está em evolução. Novos recursos, iniciativas e formas de participação poderão ser adicionados conforme a plataforma cresce.
            </p>
            <a
