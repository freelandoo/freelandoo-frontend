    ...
    <main className="flex-1 bg-background">
      ...
      <section className="relative overflow-hidden py-24 md:py-36">
        ...
        <div className="container mx-auto px-4 relative max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6" data-reveal>
            Uma plataforma para quem faz acontecer
          </h1>
          ...
          <p className="text-muted-foreground leading-relaxed" data-reveal>
            Em um mundo onde está cada vez mais fácil criar sites, apps e perfis, o desafio real é gerar conexão útil. A Freelandoo existe para organizar profissionais por intenção, dar visibilidade a quem trabalha e facilitar o encontro entre demanda e solução.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-card/20">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="text-muted-foreground leading-relaxed space-y-4" data-reveal>
            <p>
              A Freelandoo acredita que profissionais precisam de mais do que uma rede social. Eles precisam de uma vitrine organizada, com filtros claros, portfólio, serviços e uma forma simples de contato.
            </p>
            <p>
              Para quem procura, a plataforma reduz o caminho. Para quem anuncia, cria presença. Para ambos, facilita a conversa.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-card/20">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4" data-reveal>
            Uma vitrine com lógica de máquinas
          </h2>
          <p className="text-muted-foreground mb-10 leading-relaxed" data-reveal>
            As máquinas organizam profissionais por tipo de necessidade. Isso permite que clientes encontrem perfis de maneira mais intuitiva e que profissionais se posicionem com mais clareza.
          </p>
          <div className="mb-4 text-sm font-medium text-foreground" data-reveal>A Freelandoo reúne:</div>
      ...
      <section className="py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4" data-reveal>
            Estamos construindo uma nova forma de encontrar profissionais
          </h2>
          <p className="text-muted-foreground mb-10 max-w-lg mx-auto leading-relaxed" data-reveal>
            Uma plataforma simples, direta e feita para quem quer aparecer e para quem precisa resolver.
          </p>
