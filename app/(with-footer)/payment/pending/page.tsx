    ...
    <main className="fl-root flex flex-1 items-center justify-center bg-[#0b0804] px-4 py-12">
      <div className="w-full max-w-md">
        <div className="fl-card fl-hard rounded-[6px] p-8 text-center sm:p-10">
          ...
          <h1 className="fl-display mt-1 text-5xl leading-[0.9] text-[#0B0B0D]">EM ANÁLISE.</h1>
          ...
          <div className="my-6 space-y-2 border-y-2 border-dashed border-[#0B0B0D]/20 py-4 text-left">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-black text-amber-700">Pendente</span>
            </div>
            <div className="flex items-center justify-between text-sm">
              <span className="font-bold uppercase tracking-[0.1em] text-[#8a8275]">Iniciado em</span>
              <span className="font-black text-[#0B0B0D]">{new Date().toLocaleTimeString('pt-BR')}</span>
            </div>
          </div>
