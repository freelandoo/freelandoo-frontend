 ...
 * backend (/gamer/*): provedores, estante, ranking, perfil de alguém,
 * comparação, sync e desconexão.
 *
 * Voltou em 2026-09-10 com a plataforma em `/games` (tinha saído na demolição
 * da comunidade de games, quando ficou sem chamador).
 *
