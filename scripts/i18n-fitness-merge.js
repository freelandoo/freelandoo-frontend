...
const ACADEMIES = {
  ...
  seasonTitle: ["Temporada", "Season", "Temporada"],
  seasonHint: [
    "Vale as metas por uma janela fixa a partir de hoje (como nas comunidades). Sem temporada, o ranking usa o mês.",
    "Applies the goals over a fixed window starting today (like communities). Without a season, the ranking uses the month.",
    "Aplica las metas en una ventana fija desde hoy (como en las comunidades). Sin temporada, el ranking usa el mes.",
  ],
  goalDays30: ["30 dias", "30 days", "30 días"],
  goalDays60: ["60 dias", "60 days", "60 días"],
  goalDays90: ["90 dias", "90 days", "90 días"],
  seasonStart: ["Iniciar temporada", "Start season", "Iniciar temporada"],
  seasonRestart: ["Reiniciar temporada", "Restart season", "Reiniciar temporada"],
  seasonEnd: ["Encerrar", "End", "Finalizar"],
  seasonStarted: ["Temporada iniciada!", "Season started!", "¡Temporada iniciada!"],
  seasonEnded: ["Temporada encerrada.", "Season ended.", "Temporada finalizada."],
  seasonActiveLabel: ["Temporada ativa", "Season active", "Temporada activa"],
  rankingFullCta: ["Ranking da academia", "Gym ranking", "Ranking del gimnasio"],
  rankingSeeAll: ["Ver ranking completo", "See full ranking", "Ver ranking completo"],
  podiumEyebrow: ["o topo do mês", "top of the month", "lo más alto del mes"],
...
const FITNESS = {
  ...
  lockedText: [
    "O painel fitness é para quem está matriculado numa academia parceira (vincule pelo CPF) ou tem um perfil assinante.",
    "The fitness panel is for members of a partner gym (link with your CPF) or subscribers with a paid sub-profile.",
    "El panel fitness es para matriculados en un gimnasio socio (vincula con tu CPF) o suscriptores con perfil de pago.",
  ],
  lockedCtaGym: ["Vincular minha academia", "Link my gym", "Vincular mi gimnasio"],
  lockedCtaSub: ["Assinar um perfil", "Subscribe a sub-profile", "Suscribir un perfil"],
