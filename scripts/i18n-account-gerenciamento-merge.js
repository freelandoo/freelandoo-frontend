...
const ACCOUNT = {
  ...
  mgmtButtonAria: [
    "Gerenciamento da conta: perfis, serviços, cursos e produtos",
    "Account management: subprofiles, services, courses and products",
    "Gestión de la cuenta: perfiles, servicios, cursos y productos",
  ],
  ...
  mgmtProfilesTitle: ["Perfis", "Subprofiles", "Perfiles"],
  ...
  mgmtProfilesEmpty: ["Nenhum perfil ainda.", "No subprofiles yet.", "Aún no hay perfiles."],
  ...
  mgmtProfileWord: ["Perfil", "Subprofile", "Perfil"],
  ...
  mgmtDeleteProfileWarn: [
    "Excluir um perfil tira ele da vitrine e leva junto o que está vinculado a ele.",
    "Deleting a subprofile removes it from the showcase along with everything linked to it.",
    "Eliminar un perfil lo quita de la vitrina junto con todo lo vinculado a él.",
  ],
